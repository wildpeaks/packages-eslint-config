...
const fixtures = {
	...
	"class_stage0_function_without_return_type.js": {
		...
		ignored: ["strict", "class-methods-use-this", "no-unused-vars"]
	},
	...
	"class_stage2_instance_function_without_return_type.js": {
		expected: {
			legacy: ["fatal"],
			commonjs: ["fatal"],
			typescript: ["@typescript-eslint/explicit-function-return-type", "@typescript-eslint/explicit-member-accessibility"]
		},
		ignored: []
	},
	...
	"async_function.js": {
		...
		ignored: ["strict", "no-unused-vars", "@typescript-eslint/explicit-function-return-type"]
	},
	"await_in_loop.js": {
		expected: {
			legacy: ["fatal"],
	...
	"quotes_single.js": {
		...
		ignored: ["strict", "no-unused-vars", "no-var"]
	},
	"quotes_double.js": {
		expected: {
			legacy: [],
	...
	"this_function.js": {
		...
		ignored: ["no-unused-vars", "@typescript-eslint/explicit-function-return-type"]
	},
	"this_arrow.js": {
		expected: {
			legacy: ["fatal"],
	...
	"this_class_constructor.js": {
		...
		ignored: ["no-unused-vars", "@typescript-eslint/explicit-member-accessibility"]
	},
	"this_class_method.js": {
		...
		ignored: ["no-unused-vars", "@typescript-eslint/explicit-member-accessibility", "@typescript-eslint/explicit-function-return-type"]
	},
	"this_class_static.js": {
		...
		ignored: ["no-unused-vars", "@typescript-eslint/explicit-function-return-type", "@typescript-eslint/explicit-member-accessibility"]
	},
	...
	"padding_class_method_beginning_zero_lines.js": {
		...
		ignored: ["class-methods-use-this", "no-unused-vars", "@typescript-eslint/explicit-function-return-type", "@typescript-eslint/explicit-member-accessibility"]
	},
	...
	"destructuring_declare_object_param_bracket.js": {
		...
		ignored: ["strict", "no-unused-vars", "no-var", "dot-notation", "@typescript-eslint/dot-notation"]
	},
	...
	"object_many_props_single_line.js": {
		...
		ignored: ["no-unused-vars", "no-var", "max-len"]
	},
	...
	"typescript_type_single_line_commas_with_last.ts": {
		...
		ignored: ["@typescript-eslint/comma-spacing"]
	},
	...
	"mixed_operators_mixed_precedence_with_parens.js": {
		...
		ignored: ["no-undef", "no-unused-vars", "no-var"]
	},
